          ...
          <div className="flex flex-col gap-6 text-white">
            ...
            <div className='space-y-2'>
              ...
              <div className='flex items-center gap-4'>
                <span className='cursor-pointer hover:text-white text-white text-opacity-60'><ImFacebook2 size={20}/></span>
                <span className='cursor-pointer hover:text-white text-white text-opacity-60'><BsTwitter size={20}/></span>
                <span className='cursor-pointer hover:text-white text-white text-opacity-60'><BsYoutube size={25}/></span>
                <span className='cursor-pointer hover:text-white text-white text-opacity-60'><TiSocialInstagram size={25}/></span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
              <div className='flex items-center gap-2'>
                 ...
                 <div className='flex flex-col'>
                   <span className='text-xs text-white uppercase font-normal'>100% ORIGINAL guarantee</span>
              ...
              <div className='flex items-center gap-2'>
                 ...
                 <div className='flex flex-col'>
                   <span className='text-xs text-white uppercase font-normal'>Return within 30 days</span>
...
<div className="text-white w-full md:w-[20%] space-y-2">
            <span>JOIN US</span>
            <p className="text-xs sm:text-sm uppercase">Subscribe to our newsletters</p>
            <div>
              <form action="" className="space-y-2 w-full">
                <input type="text" className="w-full focus:outline-none border px-3 py-2 text-xs bg-transparent" placeholder="Email Address" />
                <div>
                  <button className="bg-[#FF7D04] hover:bg-orange-600 w-full p-2 text-xs">SUBSCRIBE</button>
                </div>
              </form>
            </div>
          </div>
